    ...
    xhr2.onload = () => {
        ...
        if(xhr2.status == 200){
            ...
            for (let x = 0; x < datas.length; x++) {
                jumKas += datas[x].kasusPosi;
                jumSem += datas[x].kasusSemb;
                jumMen += datas[x].kasusMeni;
            }
            for (let index = 0; index < datas.length; index++) {
                ...
                let persenKasus = parseFloat(((datas[index].kasusPosi/jumKas)*100).toFixed(2));
                let persenSembuh = parseFloat(((datas[index].kasusSemb/jumSem)*100).toFixed(2));
                let persenMeninggal = parseFloat(((datas[index].kasusMeni/jumMen)*100).toFixed(2)); 
                // let persentase = Math.round((datas[index].kasusPosi/jumTot)*100); 
                html +='<tr>';
                html +='<td class="text-left">'+datas[index].provinsi+'</td>';
                html +='<td class="text-center">'+datas[index].kasusPosi+'</td>';
                html +='<td class="text-center">'+datas[index].kasusSemb+'</td>';
                html +='<td class="text-center">'+datas[index].kasusMeni+'</td>';
                html +='<td class="text-center">'+persenKasus+'%</td>';
                html +='<td class="text-center">'+persenSembuh+'%</td>';
                html +='<td class="text-center">'+persenMeninggal+'%</td>';
                html +='</tr>';
            ...
            sers.push({name : 'Kasus', data : vals},{name : 'Sembuh' , data : sem}, {name : 'Meniggal' , data : death});
            ...
            //ketika error
            let html = '<tr><td class="text-center" colspan="7">Koneksi terputus, mohon coba lagi</td></tr>';
            let html2  ='<h6 class="text-center">Koneksi terputus, mohon coba lagi';
            document.getElementById("data-prov").innerHTML = html;
            document.getElementById("statprov").innerHTML = html2;
